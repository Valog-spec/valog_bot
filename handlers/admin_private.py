...
from database.orm_query import (
    ...
    orm_get_product,
    orm_get_products,
    orm_update_product, get_all_orders,
)

from filters.chat_types import ChatTypeFilter, IsAdmin
from handlers.admin_menu_processing import get_admin_menu_content

from kbds.inline import get_callback_btns
from kbds.inline_admin import AdminAction, get_orders_keyboard, OrderCallback, get_order_actions_keyboard, \
    get_admin_keyboard, get_statuses_keyboard, get_confirm_delete_keyboard
...
# async def orders(message: types.Message, session: AsyncSession):
#     orders = await get_all_orders(session)
#     await message.answer(f"вот все заказы {orders}")
...
# @admin_router.message(StateFilter(None), F.data == "Добавить товар")

...
def get_products_btns(
    ...
    keyboard.add(InlineKeyboardButton(text='Корзина 🛒',
                                      callback_data=MenuCallBack(level=3, menu_name='cart').pack()))
    keyboard.add(InlineKeyboardButton(text='В коризину 💵',
    ...
    if page:
        ...
        row2 = [
            ...
            InlineKeyboardButton(text='Заказать',
                                 callback_data=MenuCallBack(level=4, product_id=product_id, menu_name='order').pack()),
        ]
...
def get_user_orders_btns(*, level: int, sizes: tuple[int] = (2,)):
    keyboard = InlineKeyboardBuilder()
    keyboard.add(InlineKeyboardButton(text='назад',
                                      callback_data=MenuCallBack(level=0, menu_name='main').pack()))
...
def get_user_orders(
    ...
    if page:
        keyboard.add(InlineKeyboardButton(text='Оплатить',
                                          callback_data=MenuCallBack(level=6, menu_name='payment',
                                                                     product_id=product_id, order_id=order_id,
                                                                     page=page).pack()))
        keyboard.add(InlineKeyboardButton(text='Удалить',
                                          callback_data=MenuCallBack(level=7, menu_name='delete',
